<?php
/*
Template Name: Raspberry Pi Status
*/
get_header();
?>
<div id="primary">
...
<table>
		...
		<tr>
			...
			<td><img src="wp-content/themes/twentyeleven-child/img4.png" height=11 width=<?php echo $percent_used; ?>></td>
			<td><?php echo $percent_used . "%"; ?></td>
			</tr>
		<tr>
			<td>Free</td>
			<td><?php echo $free_mem; ?></td>
			<td><img src="wp-content/themes/twentyeleven-child/img1.png" height=11 width=<?php echo $percent_free; ?>></td>
			<td><?php echo $percent_free . "%"; ?></td>
			</tr>
		<tr>
			<td>Buffered</td>
			<td><?php echo $buffer_mem; ?></td>
			<td><img src="wp-content/themes/twentyeleven-child/img2.png" height=11 width=<?php echo $percent_buff; ?>></td>
			<td><?php echo $percent_buff . "%"; ?></td>
			</tr>
		<tr>
			<td>Cached</td>
			<td><?php echo $cache_mem; ?></td>
			<td><img src="wp-content/themes/twentyeleven-child/img3.png" height=11 width=<?php echo $percent_cach; ?>></td>
...
<table>
		...
		<tr>
			...
			<td><img src="wp-content/themes/twentyeleven-child/img4.png" height=11 width=<?php echo $percent_swap; ?>></td>
			<td><?php echo $percent_swap . "%"; ?></td>
		</tr>
		<tr>
			<td>Free</td>
			<td><?php echo $free_swap; ?></td>
			<td><img src="wp-content/themes/twentyeleven-child/img1.png" height=11 width=<?php echo $percent_swap_free; ?>></td>
